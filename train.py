...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='pretrained/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/cbam.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/pose.yaml', help='dataset.yaml path')
